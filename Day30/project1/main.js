...
const searchWith = (by, inputVal) => {
  if (by === "NAME") {
    ...
    mappedCountry = countries.filter(({ capital }) => {
      ...
      filteredCountry = countries.filter(({ name }) =>  name.toLowerCase().startsWith(inputVal.toLowerCase()) 
  )
    mappedCountry = filteredCountry.sort((a,b) => b.population - a.population
  )
