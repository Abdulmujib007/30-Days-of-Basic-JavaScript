...
if(fiirstName.length > laastName.legth){
  console.log("Your first name ,asabenah is longer than your last name yetayeheyeh");
}
...
let yourAge = 25;
 if(myAge > yourAge){
  ...
  if(birthYear <= 2003){
    ...
    console.log(`you are ${differ}. you will be allowed to drive after ${remain} years. `);
  }
  ...
  date = new Date;
  console.log(`${date.getFullYear()}-${ "0" + date.getMonth(0)}-${date.getDate(0)} ${ "0" + date.getHours(0)}:${ "0" + date.getMinutes(0)} `);

  console.log(`${date.getDate()}-${date.getMonth()}-${date.getFullYear()} ${date.getHours()}:${date.getMinutes()} `);

  console.log(`${date.getDate()}/${date.getMonth()}/${date.getFullYear()} ${date.getHours()}:${date.getMinutes()} `);
          // exeercise 3
  console.log(`${date.getFullYear() + "0" }-${ "0" + date.getMonth(0)}-${date.getDate(0)} ${ "0" + date.getHours(0)}:${ "0" + date.getMinutes(0)} `);
