...
console.log(countriess.sort((a,b) => a.name -b.name))
console.log(countriess.sort((a,b) => a.capital - b.capital))
console.log(countriess.sort((a,b) => a.population -b.population))

 

  // console.log(mostSpoken(countriess))

const mostPopulated = (arr,num) => {
    let populace = arr.map(value => {
        return {country:value.name,population:value.population}
    }).sort((a,b) => b.population - a.population )
    return populace.splice(0,num)
}


console.log(mostPopulated(countriess,7))
